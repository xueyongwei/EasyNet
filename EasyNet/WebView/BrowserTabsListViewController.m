...
- (void)viewDidLoad {
    ...
    [self.effectBgView addSubview:self.cardCollectionView];
...
-(UICollectionView*)cardCollectionView
{
    if (!_cardCollectionView) {
        _cardCollectionView = [[UICollectionView alloc]initWithFrame:CGRectZero collectionViewLayout:self.cardLayout];
